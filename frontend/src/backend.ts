...
export class Backend implements backendInterface {
    ...
    async changeAvailability(arg0: bigint, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.changeAvailability(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAccessLevel(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getAccessLevel();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserPurchasedVideos(arg0: Principal): Promise<Array<VideoContent>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserPurchasedVideos(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getVideosByPriceRange(arg0: bigint, arg1: bigint): Promise<Array<VideoContent>> {
        if (this.processError) {
            try {
                const result = await this.actor.getVideosByPriceRange(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async purchaseVideos(arg0: Array<bigint>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.purchaseVideos(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadVideo(arg0: string, arg1: string, arg2: Uint8Array, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        adPin: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.adPin)),
        estimatedEarnings: value.estimatedEarnings,
        displayName: value.displayName,
        secretUsername: value.secretUsername,
        isPremium: value.isPremium,
        name: value.name,
        monetizationPlan: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.monetizationPlan)),
        totalEarnings: value.totalEarnings,
        isMonetized: value.isMonetized,
        cpmRank: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.cpmRank)),
        subscriberCount: value.subscriberCount,
        paypalEmail: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.paypalEmail)),
...
function to_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        isTrusted: value.isTrusted,
        adPin: value.adPin ? candid_some(value.adPin) : candid_none(),
        estimatedEarnings: value.estimatedEarnings,
        displayName: value.displayName,
        secretUsername: value.secretUsername,
        isPremium: value.isPremium,
        name: value.name,
        monetizationPlan: value.monetizationPlan ? candid_some(value.monetizationPlan) : candid_none(),
        totalEarnings: value.totalEarnings,
        isMonetized: value.isMonetized,
        cpmRank: value.cpmRank ? candid_some(value.cpmRank) : candid_none(),
        subscriberCount: value.subscriberCount,
